when we apply IBVS for UAV landing, if the UAV decreases its altitute when its horizontal position is far from the center of the landing target, the features can get easily out of the image plane. 
